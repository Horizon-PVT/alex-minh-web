  ...
  return (
    <div className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Caution banner */}
        <div className="mb-10 max-w-4xl mx-auto p-4 bg-slate-900/60 border border-slate-800 rounded-2xl flex items-start space-x-3 text-slate-300 font-medium">
            ...
            <div className="p-4 border-t border-slate-800 bg-[#090d16]">
                ...
                <div className="flex flex-col gap-2 mb-3 max-h-36 overflow-y-auto">
                  {activeStep.options.map((opt) => (
                    <button
                      ...
                      className="text-left w-full px-4 py-2.5 bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-secondary/40 text-slate-200 hover:text-white rounded-xl text-xs font-semibold transition-all cursor-pointer"
                    >
                      {opt.label}
                    </button>
                  ))}
              ...
              <form onSubmit={handleInputSubmit} className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs sm:text-sm text-slate-100 placeholder-slate-500 outline-none focus:border-secondary/50"
                />
                <button
                  type="submit"
